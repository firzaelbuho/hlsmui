...
private val emeraldLightColorScheme = lightColorScheme(
    primary = Color(0xFF4CAF50),  // Emerald green for primary color
    onPrimary = Color(0xFFFFFFFF),  // White text on primary
    primaryContainer = Color(0xFFD8F8D4),  // Light green container for primary
    onPrimaryContainer = Color(0xFF000000),  // Black text on primary container
    inversePrimary = Color(0xFF76FF03),  // Inverse primary color

    secondary = Color(0xFF00796B),  // Emerald teal for secondary
    ...
    surfaceTint = Color(0xFF4CAF50),  // Tint color for surfaces
    ...
    outline = Color(0xFF4CAF50),  // Outline color matching primary
    ...
    surfaceContainerHighest = Color(0xFF4CAF50),  // Highest container for accent
...
private val emeraldDarkColorScheme = darkColorScheme(
    primary = Color(0xFF4CAF50),  // Emerald green for primary color
    onPrimary = Color(0xFFFFFFFF),  // White text on primary
    primaryContainer = Color(0xFFD8F8D4),  // Darker shade for primary container
    onPrimaryContainer = Color(0xFF000000),  // Black text on primary container

    secondary = Color(0xFF00796B),  // Emerald teal for secondary
    onSecondary = Color(0xFFFFFFFF),  // White text on secondary
    secondaryContainer = Color(0xFFB2EBF2),  // Darker teal
    ...
    surfaceTint = Color(0xFF4CAF50),  // Tint color for dark surfaces
    ...
    outline = Color(0xFF4CAF50),  // Light outline
    ...
    surfaceContainerHighest = Color(0xFF4CAF50),  // Highest container in dark mode
...
internal val EmeraldColorScheme = HlsmColorScheme(
    lightScheme = emeraldLightColorScheme,
    darkScheme = emeraldDarkColorScheme
)
