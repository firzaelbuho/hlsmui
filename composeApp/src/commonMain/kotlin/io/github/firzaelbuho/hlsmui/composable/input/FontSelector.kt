...
@Composable
fun FontSelector(
    currentHlsmFont: HlsmFont,
    hlsmFontList: List<HlsmFont> = HlsmFont.entries,
    onHlsmFontSelected: (HlsmFont) -> Unit // Fungsi untuk menangani tema yang dipilih
) {
...
//            ),
        ...
        DropdownMenu(
            ...
            hlsmFontList.forEach { hlsmFont ->
                DropdownMenuItem(

                    onClick = {
                        onHlsmFontSelected(hlsmFont) // Memanggil fungsi saat tema dipilih
